...
# T permite asignar una opción al resto de casos
...
#Aplicación de la librería parsnip para seleccionar el modelo
...
#Probar el modelo en datos nuevos
...
kknn_fit%>%
  ...
  #Matriz de confusión a partir de los nuevos datos (definiendo el corte en 0,5)
  kknn_fit%>%
  predict(new_data =test_proc,type="prob")%>%
  mutate(verdadero=hotel_test$children)%>%
